...
var helloMessage = sayHello("Cristian");
...
function calculateTip(tipPercent, totalBill){
    return(tipPercent * .01) * (totalBill);
}

console.log(calculateTip(15, 100))
 ...
 */
//alert("your tip should be: " + calculateTip(prompt("how much do you want to tip"), prompt("How much was your total bill?"));
